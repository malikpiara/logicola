...
> = {
  ...
  // being ported incrementally. See the remaining template ports for
  ...
  // Layer-2 hints from the original program. See
  // the Set C fidelity audit for the per-template inventory.
  ...
  // (A ⊃ ☐B) and ☐(A ⊃ B)" form. See Gensler's textbook.
  ...
  // can't recur. See Gensler's textbook.
