// AUTO-GENERATED by the port — review, do not hand-edit passages.
// Structure + answers: the original program for Set R (original program).
// The parsed JSON available is defective (drops section 14, mangles the last sm entry).
//
...
// the Set R port, never this file. The dates exist so that a reader years
...
//
// Wording follows the original program except where Gensler himself later revised the same
// exercise for Introduction to Logic 3rd ed. (Routledge, 2017) §4.2a — the drill set
// these passages come from. Those revisions are listed in the Set R port's REVISIONS
