// AUTO-GENERATED by the Set R port — review, do not hand-edit passages.
// Structure + answers: the original program for Set R.
// The legacy parsed JSON is defective (drops section 14, mangles the last sm entry).
//
